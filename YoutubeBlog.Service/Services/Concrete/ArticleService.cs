...
namespace YoutubeBlog.Service.Services.Concrete
{
    public class ArticleService : IArticleService
    {
        ...
        {
            var article = await unitOfWork.GetRepository<Article>().GetAsync(x => x.IsDeleted == false && x.Id == articleId, x => x.Category, x => x.Image);
        ...
        public async Task<string> UpdateArticleAsync(ArticleUpdateDto articleUpdateDto)
        {
            ...
            var article = await unitOfWork.GetRepository<Article>().GetAsync(x => x.IsDeleted == false && x.Id == articleUpdateDto.Id, x => x.Category, x => x.Image);
